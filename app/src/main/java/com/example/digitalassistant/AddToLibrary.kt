...
@Composable
fun AddToLibraryScreen(navController: NavController,nsharedViewModel: SharedViewModel) {
        ...
        Button(
            onClick = {
                if(text_name.isNotEmpty() && text_cate.isNotEmpty()){
                    ...
                    val event = EventLibrary(event_name = text_name, event_category = text_cate,
                        event_image = imagePath)
                    eventViewModel.addEventLibrary(event)
